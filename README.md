...
This repository contains [`evm.json`](./evm.json) file with test cases. Your goal is to create an implementation in any programming language of your choice that passes all tests.
...
The repository contains templates for JavaScript, TypeScript, Python, Go and Rust. However, you don't have to use the existing templates, you can build your own test suite based on [`evm.json`](./evm.json) (or `evm-pro.json`, see below).
...
**Get the full [EVM From Scratch course here](https://evmfromscratch.com/)**.

## Credits

All the materials in the repository are made by [w1nt3r.eth](https://twitter.com/w1nt3r_eth). The repository is part of the "EVM From Scratch" course.
